...
# Caminho para o banco de dados do histórico do Firefox
firefox_db_path = os.path.expanduser("~/.mozilla/firefox/*.default-release/places.sqlite")  # Ajuste se necessário
# Nome do arquivo que irá armazenar o histórico filtrado
arquivo_saida = "history/firefox.txt"
...
def acessar_historico_firefox():
    ...
    while attempt < max_attempts:
        try:
            # Substitui o caminho pelo primeiro perfil encontrado
...
salvar_novo_historico(historico_firefox)
